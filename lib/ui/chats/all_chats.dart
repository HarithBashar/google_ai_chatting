...
class _AllChatsState extends State<AllChats> {
  ...
  void startNewChat() async {
    controller.allChats.add(ChatClass(messages: [], title: '', startChatTime: DateTime.now(), lastChatTime: DateTime.now(), id: generateId()));
                            ...
                            child: Center(
                              child: Column(
                                ...
                                children: [
                                  SizedBox(
                                    width: size.width * .6,
                                    child: Image.asset('assets/icons/chatPic.png'),
                                  ),
                                  Text(
                                    "Start new chat...",
