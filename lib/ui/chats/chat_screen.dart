                                    ...
                                    children: [
                                      Directionality(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(widget.chat.messages[index].sender == 0 ? "You:" : "Gemini Ai:", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFfdffd4))),
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () async {
                        ...
                        // widget.chat.generateImage(message);
                        // return;
